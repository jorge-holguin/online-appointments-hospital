          ...
          // 1. Content Security Policy (CSP) - Protección contra XSS
          {
            ...
            value: isProduction 
              ? [
                  ...
                  "connect-src 'self' http://192.168.0.252:9012 http://192.168.0.252:9012/api http://192.168.0.252:9011 https://citas.hospitalchosica.gob.pe https://*.hospitalchosica.gob.pe",
