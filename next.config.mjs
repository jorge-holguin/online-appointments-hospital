        ...
        headers: [
          // 1. Content Security Policy (CSP) - Protección contra XSS
          {
            ...
            value: [
              ...
              // En producción, Next.js genera hashes automáticos para scripts inline
              ...
              // Restringir img-src: eliminar comodín 'https:' y especificar dominios
              ...
              // Permitir conexiones a APIs tanto en desarrollo como producción
              ...
              "base-uri 'self'",
              "form-action 'self'",
              // frame-ancestors 'none' previene que el sitio sea embebido en iframes (anti-clickjacking)
              "frame-ancestors 'none'",
              // upgrade-insecure-requests - COMENTADO para desarrollo, descomentar en producción
          ...
          // 7. Strict-Transport-Security - Forzar HTTPS SOLO en producción
          // COMENTADO para desarrollo - descomentar en producción con HTTPS
          // {
